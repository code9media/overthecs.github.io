...
<div class="content content-400">
    <div class="board board-326">
        ...
        <div class="board-card">
            ...
            <ul>
                <li><a href="http://www.sybase.com/">Official Website</a></li>
                <li><a href="http://en.wikipedia.org/wiki/Sybase_SQL_Server">Wikipedia Sybase</a></li>
            </ul>
        </div>
        <div class="board-card">
            <h3 class="board-card-title">Download</h3>
            <ul>
                <li><a href="http://www.selectorweb.com/sql_sybase.html">Sybase SQL Server 11</a></li>
            </ul>
        </div>
        <div class="board-card">
